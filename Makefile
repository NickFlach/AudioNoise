...
effects = flanger echo fm phaser discont am basspurr
...
basspurr_defaults = 0.5 0.6 0.4 0.8

HEADERS = biquad.h  basspurr.h  discont.h  echo.h  effect.h  flanger.h  fm.h  gensin.h lfo.h  phaser.h  util.h
